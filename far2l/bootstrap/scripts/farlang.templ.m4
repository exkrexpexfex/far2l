...
ProcessListTitle
l:
"Список задач (PID, User, Name, Command, CPU, RSS), Автообновление: %s, Сортировка: %c"
"Task list (PID, User, Name, Command, CPU, RSS), AutoRefresh: %s, Sort: %c"
"Seznam úloh (PID, User, Name, Command, CPU, RSS), AutoRefresh: %s, Sort: %c"
"Taskliste (PID, User, Name, Command, CPU, RSS), AutoRefresh: %s, Sort: %c"
"Futó programok (PID, User, Name, Command, CPU, RSS), AutoRefresh: %s, Sort: %c"
"Lista zadań (PID, User, Name, Command, CPU, RSS), AutoRefresh: %s, Sort: %c"
"Lista de tareas (PID, User, Name, Command, CPU, RSS), AutoRefresh: %s, Sort: %c"
"Список завдань (PID, User, Name, Command, CPU, RSS), AutoRefresh: %s, Sort: %c"
"Спіс &заданняў (PID, User, Name, Command, CPU, RSS), AutoRefresh: %s, Sort: %c"

ProcessListBottom
"SIGTERM: Del, SIGKILL: Shift+Del, AutoRefresh: Ctrl+R, Sort: t/T name, i/I PID, p/P CPU, m/M RSS, Search: ^⌥F"
"SIGTERM: Del, SIGKILL: Shift+Del, AutoRefresh: Ctrl+R, Sort: t/T name, i/I PID, p/P CPU, m/M RSS, Search: ^⌥F"
"SIGTERM: Del, SIGKILL: Shift+Del, AutoRefresh: Ctrl+R, Sort: t/T name, i/I PID, p/P CPU, m/M RSS, Search: ^⌥F"
"SIGTERM: Entf, SIGKILL: Shift+Entf, AutoRefresh: StrgR, Sort: t/T name, i/I PID, p/P CPU, m/M RSS, Search: ^⌥F"
"SIGTERM: Del, SIGKILL: Shift+Del, AutoRefresh: Ctrl+R, Sort: t/T name, i/I PID, p/P CPU, m/M RSS, Search: ^⌥F"
"SIGTERM: Del, SIGKILL: Shift+Del, AutoRefresh: Ctrl+R, Sort: t/T name, i/I PID, p/P CPU, m/M RSS, Search: ^⌥F"
"SIGTERM: Del, SIGKILL: Shift+Del, AutoRefresh: Ctrl+R, Sort: t/T name, i/I PID, p/P CPU, m/M RSS, Search: ^⌥F"
"SIGTERM: Del, SIGKILL: Shift+Del, AutoRefresh: Ctrl+R, Sort: t/T name, i/I PID, p/P CPU, m/M RSS, Search: ^⌥F"
